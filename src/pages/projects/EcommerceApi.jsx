...
const SistemMonitoring = () => {
  ...
  return (
    <div className="container mx-auto px-6 py-12">
      ...
      <img src="https://images.unsplash.com/photo-1556740738-b6a63e27c4df?q=80&w=2070&auto=format&fit=crop" alt="Gambar Sistem Monitoring" className="w-full h-auto max-h-[500px] object-cover rounded-lg shadow-lg mb-8" />
